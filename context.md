...
- **Còn lại (TODOS.md)**: harness test DB (Testcontainers/Respawn) + SignalR hub test CHƯA dựng — cần trước khi coi là hoàn tất; gating focus/scroll cho mark-read là polish.
