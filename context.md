...
1. **Badge "chưa đọc" (unread) theo từng phòng/DM** — hiện chỉ có banner `ReceiveNotification` thoáng qua rồi biến mất (`ChatView.tsx:242`), không có đếm tin chưa đọc bền vững → dễ bỏ lỡ tin nhắn riêng khi đang ở phòng khác. *(Ưu tiên cao nhất — đúng "không bỏ lỡ phản hồi".)*
